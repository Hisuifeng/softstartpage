...
- **多引擎搜索**：![alt](img/engsc.png)<br>内置 Google / Bing / Baidu 等引擎，可自定义搜索引擎，支持 `Ctrl/Alt/Shift + 数字` 快捷切换
...
- **世界时钟**：![alt](img/clocksc.png)<br>在世界时钟可以增加和编辑不同时区的时钟，查看多时区时间，预设常用城市，支持手动输入 UTC±HH:MM
- **动态背景**：
